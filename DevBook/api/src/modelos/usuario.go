...
// preparar vai chamar os usuarios metodos para validar e formatar
...
func (usuario *Usuario) validar(etapa string) error {
	...
	if erro := checkmail.ValidateFormat(usuario.Email); erro != nil {
		return errors.New("O email inserido é valido")
	}

	if etapa == "cadastro" && usuario.Senha == "" {
		return errors.New(" O senha é obrigatoria e nao pode ser em branco")
	}
